...
class ImageTrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        root = '/home/ubd/EMANet-master/Video_Prediction_ZOO-master/cal_train/'
        start = 25690- self.nt
        end = 25690
        frame_seq = []
#         print('index 0',index)
...
class ImageTestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        index_0 = index - self.nt
        root = '/home/ubd/EMANet-master/Video_Prediction_ZOO-master/cal_test/'
        start = 21985- self.nt
        end = 21985
        frame_seq = []
#         print('index 0',index)
...
class ImageValDataset(Dataset):
    ...
    def __getitem__(self, index):
        root = '/home/ubd/EMANet-master/Video_Prediction_ZOO-master/cal_val/'
        start = 1750 - self.nt
        end = 1750
        frame_seq = []
#         print('index 0',index)
